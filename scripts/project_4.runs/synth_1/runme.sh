...
HD_PWD='C:/Users/NTH417/Desktop/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Enigma_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Enigma_top.tcl
